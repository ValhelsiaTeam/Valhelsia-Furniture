...
public class ModBlockTagsProvider extends ValhelsiaBlockTagsProvider {
    ...
    protected void addTags(HolderLookup.Provider provider) {
        ...
        this.blockTag(ModTags.Blocks.STOOLS).add(ModBlocks.OAK_STOOL, ModBlocks.SPRUCE_STOOL, ModBlocks.BIRCH_STOOL, ModBlocks.JUNGLE_STOOL, ModBlocks.ACACIA_STOOL, ModBlocks.DARK_OAK_STOOL, ModBlocks.MANGROVE_STOOL, ModBlocks.CRIMSON_STOOL, ModBlocks.WARPED_STOOL);
        ...
        this.blockTag(ModTags.Blocks.DESKS).addTag(ModTags.Blocks.OAK_DESKS).addTag(ModTags.Blocks.SPRUCE_DESKS).addTag(ModTags.Blocks.BIRCH_DESKS).addTag(ModTags.Blocks.JUNGLE_DESKS).addTag(ModTags.Blocks.ACACIA_DESKS).addTag(ModTags.Blocks.DARK_OAK_DESKS).addTag(ModTags.Blocks.MANGROVE_DESKS).addTag(ModTags.Blocks.CRIMSON_DESKS).addTag(ModTags.Blocks.WARPED_DESKS);
