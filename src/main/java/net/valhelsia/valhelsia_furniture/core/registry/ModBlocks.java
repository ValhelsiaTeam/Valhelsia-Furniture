...
public class ModBlocks implements RegistryClass {
    ...
    @RenderType(ValhelsiaRenderType.CUTOUT)
    public static final RegistryObject<TableBlock> MANGROVE_TABLE = HELPER.register("mangrove_table", () -> new TableBlock("mangrove_table", BlockBehaviour.Properties.copy(Blocks.OAK_PLANKS)));
    @RenderType(ValhelsiaRenderType.CUTOUT)
