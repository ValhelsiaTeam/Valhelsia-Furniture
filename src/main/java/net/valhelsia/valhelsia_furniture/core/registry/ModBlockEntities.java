...
public class ModBlockEntities implements RegistryClass {
    ...
    public static final MappedRegistryHelper<BlockEntityType<?>> HELPER = ValhelsiaFurniture.REGISTRY_MANAGER.getMappedHelper(ForgeRegistries.Keys.BLOCK_ENTITY_TYPES);
